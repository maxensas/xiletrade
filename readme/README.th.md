# <img src="https://i.imgur.com/dhWQgtY.png" width="30" height="30"> Xiletrade (POE Helper) - [Download v1.5.1](https://github.com/maxensas/xiletrade/releases/download/1.5.1/Xiletrade_win-x64.rar)  
...
### 1.5 การนำเสนอผลงาน : [ราคา](https://youtu.be/4mP3uOsr8oc) - [จำนวนมาก](https://youtu.be/6yuLZXTho-A) - [การตั้งค่า](https://youtu.be/libdIjrNM-8 )<br>
...
> Xiletrade ติดตามการเปลี่ยนแปลงที่เกิดขึ้นและใช้ [เว็บไซต์อย่างเป็นทางการ](https://th.pathofexile.com/trade/search/) เพื่อดึงราคาโดยประมาณที่ดี<br>
...
> #### คุณสามารถช่วยโครงการได้โดยการบริจาคโดยใช้ [PayPal](https://www.paypal.com/donate/?hosted_button_id=48ZSB3UMNAU6J) หรือเป็นผู้มีพระคุณรายใหม่ (และเพลิดเพลินไปกับคุณสมบัติพิเศษในอนาคตอันใกล้) บน [Liberapay](https://en.liberapay.com/Xiletrade/) ลิงก์สามารถพบได้ในเครื่องมือ
...
Xiletrade ไม่มีส่วนเกี่ยวข้องหรือรับรองโดย Grinding Gear Games แต่อย่างใด<br>
คุณได้รับเชิญให้อ่านนโยบายของ GGG เกี่ยวกับเครื่องมือของบุคคลที่สามผ่านลิงก์ด้านบน ปฏิบัติตามมาตรการทั้งหมดที่เกี่ยวข้องกับแอพที่ปฏิบัติการได้ การจัดการการให้สิทธิ์ด้วย 0auth2 จะถูกใช้งานบน Xiletrade ซึ่งต้องใช้เซิร์ฟเวอร์เฉพาะเพื่อทำงาน<br> 
...
## ภาพหน้าจอ - [ในการดำเนินการ](https://github.com/maxensas/xiletrade/blob/master/SCREENSHOTS.md)
