# <img src="https://i.imgur.com/dhWQgtY.png" width="30" height="30"> Xiletrade (POE Helper) - [Download v1.3.1 ](https://github.com/maxensas/xiletrade/releases/download/v1.3.1/Xiletrade_win-x64.rar)  
...
[![release](https://img.shields.io/badge/Release-v1.3.1-brightgreen.svg)](https://github.com/maxensas/xiletrade/releases) 
...
> #### Вы можете помочь проекту, сделав пожертвование с помощью [PayPal](https://www.paypal.com/donate/?token=9zX_z7wnneHW8GsUxn-T3fUiqqPeFHfRCD9dAS8O21_n4CR6sXyJN4XmyjBZwroo2c) или станьте специальным патроном в будущем. на [Liberapay](https://liberapay.com/Xiletrade/) ссылки можно найти на самом инструменте.
...
### Особые слова о понравившейся игре
Xiletrade поможет со своими функциями, но предотвратит неправильное использование. С внешней точки зрения, у GGG расплывчатая политика в отношении механики внутриигровой торговли и сторонних инструментов, но мы должны уважать их решения: Path of exile был и остается их детищем. С запуском PoE 2 можно ожидать обновления торговли, о чем мы никогда не узнаем.
...
Или когда я могу стримить на [моем канале Twitch](https://www.twitch.tv/maxensas/)
