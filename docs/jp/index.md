...
<section class="intro">
  <p><strong>Xiletrade は、Path of Exile 1 および 2 との最適な統合を実現するミニマルなインターフェースを提供します。</strong></p>
  <p>その機能により、トレードリーグでのプレイ体験が向上し、快適でスムーズな体験を保証します。</p>
  <p>オープンソースとして、コードベースは細部まで丁寧に管理され、可能な限り最適化されたツールを提供します。 
  以下では、PoE におけるアイテム価格チェックに関するすべてのカスタマイズ可能な挙動をご確認いただけます。</p>
</section>
