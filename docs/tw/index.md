...
<section class="intro">
  <p><strong>Xiletrade 提供極簡化介面，與 Path of Exile 1 與 2 完美整合。</strong></p>
  <p>透過其功能，可在交易聯盟中提升遊戲體驗，並確保操作順暢。</p>
  <p>作為開源專案，其程式碼經過細心維護，為你提供最優化的工具。 
  下方列出了 PoE 中所有與物品價格查詢相關的可自訂行為。</p>
</section>
