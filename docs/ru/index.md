...
## Проверьте цену товара

<h2 class="keywords"><i>🔍 Найдите оптимальный ценовой диапазон.</i></h2>
<h2 class="keywords"><i>⚡ Настраивайте поведение на лету.</i></h2>
<h2 class="keywords"><i>🎮 Играйте плавнее, торгуйте быстрее!</i></h2>

#### {% include youtube.svg %} &nbsp; [Посмотрите краткий обзор](https://youtu.be/NygCZvZyUX0)<br>

Низкая загрузка CPU.  
Использует максимум 250 МБ ОЗУ, без пиков.  
В фоне данные не записываются.  

* * *
<br><br><br>

### {% include direction.svg %} Краткое введение

<h2 class="keywords"><strong>Xiletrade предлагает минималистичный интерфейс для оптимальной интеграции с Path of Exile 1 и 2.</strong></h2>
<section class="intro">
  <p>Благодаря своим функциям, он улучшает качество вашей игры в торговых лигах, обеспечивая плавный опыт.</p>
  <p>Будучи open source, его код тщательно прорабатывается, чтобы предоставить вам максимально оптимизированный инструмент. 
  Ниже вы найдете полный список настраиваемых действий по проверке цен предметов в POE.</p>
</section>
...
<p class="accordion"><b>Просмотреть подробности проверки цен</b></p>
<div class="panel"> Помните, что игра должна быть в фокусе, иначе сочетание клавиш не будет работать.
<br><br> Например, если вы оставите окно Xiletrade открытым, кликнете по нему (чтобы Xiletrade получил фокус), а затем попробуете выполнить ещё одну проверку цены, она не сработает. Однако вы можете проверять цены нескольких предметов подряд, если не нажимаете на окно Xiletrade.
<br><br> Каждый раз, когда PoE теряет фокус, сочетания клавиш автоматически отменяются и регистрируются заново, когда PoE снова получает фокус.
<br><br> Также имейте в виду, что не стоит выполнять слишком много проверок цен подряд, чтобы избежать временной блокировки на торговом сайте PoE. Инструмент предупредит вас при превышении лимитов и защитит от массового тайм-аута.
</div>
