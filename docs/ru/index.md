...
<section class="intro">
  <p><strong>Xiletrade предлагает минималистичный интерфейс для оптимальной интеграции с Path of Exile 1 и 2.</strong></p>
  <p>Благодаря своим возможностям он улучшает качество игры в торговых лигах, обеспечивая плавный игровой процесс.</p>
  <p>Будучи проектом с открытым исходным кодом, его кодовая база тщательно поддерживается, чтобы предоставить вам максимально оптимизированный инструмент. 
  Ниже вы найдёте полный список настраиваемых параметров, связанных с проверкой цен предметов в PoE.</p>
</section>
