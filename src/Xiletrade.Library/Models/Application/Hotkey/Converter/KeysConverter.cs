...
/// </summary>
public class KeysConverter : TypeConverter, IComparer, IKeysConverter
{
    ...
    private void AddLocalizedKeyNames(CultureInfo cultureInfo)
    {
        ...
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter001_Enter), Keys.Return);
        AddKey("F12", Keys.F12);
        AddKey("F11", Keys.F11);
        AddKey("F10", Keys.F10);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter002_End), Keys.End);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter003_Control), Keys.Control);
        AddKey("F8", Keys.F8);
        AddKey("F9", Keys.F9);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter004_Alt), Keys.Alt);
        AddKey("F4", Keys.F4);
        AddKey("F5", Keys.F5);
        AddKey("F6", Keys.F6);
        AddKey("F7", Keys.F7);
        ...
        AddKey("F2", Keys.F2);
        AddKey("F3", Keys.F3);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter005_PageDown), Keys.Next);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter006_Insert), Keys.Insert);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter007_Home), Keys.Home);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter008_Delete), Keys.Delete);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter009_Shift), Keys.Shift);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter010_PageUp), Keys.Prior);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter011_Back), Keys.Back);
        AddLocalizedKey(nameof(Resources.Resources.KeysConverter012_None), Keys.None);
        ...
        void AddLocalizedKey(string keyName, Keys value)
        {
            ...
            string key = rm.GetString(keyName, cultureInfo) ??
                throw new InvalidOperationException(string.Format(Resources.Resources.KeysConverter013_ResourceValueNotFound, keyName));
            AddKey(key, value);
        }
    }
        ...
        if (value is string text)
        {
            ...
            foreach (string token in tokens)
            {
                ...
                if ((currentKey & Keys.KeyCode) != 0)
                {
                    ...
                    if (foundKeyCode)
                    {
                        throw new FormatException(Resources.Resources.KeysConverter014_InvalidKeyCombination);
                    }
