...
internal static class Display
{
    ...
    */
    public static Dictionary<KeyValuePair<int, int>, KeyValuePair<int, int>> ResolutionList { get; private set; } = new()
    {
        ...
        { new KeyValuePair<int,int>(2560,1440), new KeyValuePair<int,int>(0,0) }, // 2K
        { new KeyValuePair<int,int>(3840,2160), new KeyValuePair<int,int>(0,0) }, // 4K
        { new KeyValuePair<int,int>(3325,1871), new KeyValuePair<int,int>(0,0) },
        { new KeyValuePair<int,int>(2880,1620), new KeyValuePair<int,int>(0,0) },
        { new KeyValuePair<int,int>(2715,1527), new KeyValuePair<int,int>(0,0) },
