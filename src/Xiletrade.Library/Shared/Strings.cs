...
public static class Strings 
{
    ...
    internal static class Feature
    {
        ...
        internal static readonly List<string> ChatCommands = new() { "remaining", "reset_xp", "ladder", "delve",
            "menagerie", "metamorph", "cls", "deaths", "passives", "age", "played", "destroy", "guild", "atlaspassives"};
    }
    ...
    */
    ...
    internal static readonly Dictionary<string, string> dicInherit = new()
    {
        ...
        {Inherit.Sentinel, "sentinel"}, {Inherit.Charms, "azmeri.charm"}, {Inherit.Tinctures, "azmeri.tincture"}
    };
