...
/// </remarks>
public class UnitTestWords : UnitTest<WordData>
{
    public UnitTestWords() : base("Words")
    {
    ...
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[0]));
    ...
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[1]));
    ...
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[2]));
    ...
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[3]));
    ...
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[4]));
    ...
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[5]));
    ...
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[6]));
        Assert.Equal(Jsons.GetValueOrDefault(Culture[6]), net);
    }
    [Fact]
    public void _07_TH_SerializeWithNET()
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[7]));
        Assert.Equal(Jsons.GetValueOrDefault(Culture[7]), net);
    }
    [Fact]
    public void _08_TW_SerializeWithNET()
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[8]));
        Assert.Equal(Jsons.GetValueOrDefault(Culture[8]), net);
    }
    [Fact]
    public void _09_CN_SerializeWithNET()
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[9]));
        Assert.Equal(Jsons.GetValueOrDefault(Culture[9]), net);
    }
    [Fact]
    public void _10_JP_SerializeWithNET()
    {
        var net = NETSerializer.Serialize<WordData>(Serializable.GetValueOrDefault(Culture[10]));
